...
::: tip 提示
如您已有1.18.2的Java版，则可以直接进行 [114]() 步骤
:::
...
BakaXL将引导您进行一些设置 如下图，按照其提示完成所有步骤
![BakaXL 初始化](./BakaXL-init.png)
...
![000](./21.png)
![000](./22.png)
3.返回首页，点击“启动游戏”（如果您没有下载与游戏版本对应的Java版本，启动器会弹出提示，指引您完成下载 下载完成后即可启动游戏）
![000](./10.png)
![000](./23.png)
![000](./24.png)
![000](./25.png)
